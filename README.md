# sanity-gatsby-human-studios-portfolio
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/wet7gxtw/settings/api) and create a token with read rights.
